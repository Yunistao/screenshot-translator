...
type LLMProvider = 'openai' | 'siliconflow' | 'openai-compatible' | 'claude' | 'gemini';
...
const buildSystemPrompt = (fromLang: string, toLang: string): string => {
...
const translateWithChatCompletions = async (
  text: string,
  fromLang: string,
  toLang: string,
